    ...
    function checkIfCorrect() {
        document.onkeyup = function(event) {
            ...
            if (event.keyCode < 65 || event.keyCode > 90) {
                ...
                console.log("You win.");
                document.getElementById("image-here").setAttribute("src", "assets/images/LightOn.gif");
                setTimeout(function(){alert("You win!");}, 3000);
				wins = wins + 1;
                document.getElementById("your-wins").innerHTML = wins;
                setTimeout(function(){document.getElementById("image-here").setAttribute("src", "assets/images/LightOff.png");}, 3000);
                resetGame();
            }
            else {
